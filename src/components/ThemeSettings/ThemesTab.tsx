...
function ThemesTab() {
    ...
    const predefinedThemes = [
        ...
        },
        {
            ...
            author: "PEACE",
            description: "Rich Blue hues, blended with baby blue and a touch of swirls of frothy white.",
        },
        {
            ...
            author: "PEACE",
            description: "Dark blue hues, layered with creamy purple and a touch of blue caramel tones.",
        },
        {
            ...
            author: "PEACE",
            description: "Deep purple colors, blended with warm creamy purple and blue undertones.",
        },
        {
