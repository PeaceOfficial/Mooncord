...
import { EquicordDevsById, MooncordDevsById, VencordDevsById } from "@utils/constants";
...
function ContributorModal({ user }: { user: User; }) {
    ...
    const plugins = useMemo(() => {
        ...
        const pluginsByAuthor = VencordDevsById[user.id] || EquicordDevsById[user.id] || MooncordDevsById[user.id]
            ? allPlugins.filter(p => p.authors.includes(VencordDevsById[user.id] || EquicordDevsById[user.id] || MooncordDevsById[user.id]))
    ...
    const ContributedHyperLink = <Link href="https://github.com/PeaceOfficial/Mooncord">contributed</Link>;
