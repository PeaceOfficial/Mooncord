...
const BadgeSettings = () => {
    const [images, setImages] = useState([
        { src: "https://i.imgur.com/dL3FdMS.png", shown: settings.store.showEquicordDonor, title: "Equicord donor badges", key: "EquicordDonor", position: settings.store.EquicordDonorPosition },
        { src: "https://i.imgur.com/dL3FdMS.png", shown: settings.store.showEquicordContributor, title: "Equicord contributor badge", key: "EquicordContributer", position: settings.store.EquicordContributorPosition },
